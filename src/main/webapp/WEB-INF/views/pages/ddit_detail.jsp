...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="/board/boardlist.do">
		  ...
		  <div class="col-md-8">
		    <div class="h-100">
              ...
              <p class="mb-0 font-weight-normal text-sm">
             	작성자 : ${board.boWriter } /  작성일 :  ${board.boDate } / 조회수 :  ${board.boHit }
              </p>
            </div>
		  </div>
		</div>
            ...
            <div class="col-md-12">
              <div class="card card-plain h-100">
				...
				<div class="card-footer p-3">
				    ...
				    <input type="button" value="삭제" id="delBtn" class="btn btn-outline-primary"></button>
					<input type="button" value="수정" id="updateBtn" class="btn btn-outline-secondary">
				    <input type="button" value="목록" id="listBtn" class="btn btn-outline-success">
				</div>
              </div>
            </div>
