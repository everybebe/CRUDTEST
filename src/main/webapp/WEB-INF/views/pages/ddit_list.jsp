        ...
        <div class="col-12">
         ...
         <div class="card-body px-0 pb-2">
           <div class="row">
	            ...
	            <form class="input-group input-group-sm" method="get" id="searchForm" style="width: 440px;">
         ...
         <div class="card-footer clearfix" id="pagingArea">
            ${pagingVO.pagingHTML }
              ...
              <button style="text-align:right" type="button" class="btn btn-outline-secondary" id="newBtn">글등록</button>
        </div>
      </div>
    </div>
  </main>
